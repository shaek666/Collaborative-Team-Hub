      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-slate-800 space-y-3">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span
                    ...
                    className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-white text-[10px] flex items-center justify-center rounded-full border-2 border-slate-900"
                  >
                    {unreadCount}
                  </span>
                )}
          ...
          <Link href="/profile" className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-800 transition-all group">
            <div className="w-8 h-8 rounded-full bg-slate-700 border border-slate-600 overflow-hidden flex-shrink-0 group-hover:border-blue-500/50 transition-colors">
              {user?.avatarUrl ? (
